        ...
        <div class="form">
          <form method="post" action="index.php">
            ...
            <div>
              ...
              <?php  if (isset($error['email1'])) { echo $error['email1'] ;}
            ...
            <div>
              <label for="msg"></label>
              <textarea rows="5" cols="50" id="msg" name="user_message" placeholder="Votre message :"></textarea><span class="error">
                <?php if (isset($error['message1'])) { echo $error['message1'];}
              ?></span><br><br>
            </div>

            <div>
              <button type="submit" id="send">Envoyez votre message</button>
            </div>
